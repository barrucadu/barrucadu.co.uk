...
description: Concurrent programs have too many legal schedules to try
  all of them, but fortunately we don't need to.
---
...
![Schedule tree](/postfiles/2015-08-21-schedtree.png)
...
![Scheduling choice leading to immediate block](/postfiles/2015-08-21-blocking.png)
...
![Two executions with the same result, amenable to POR](/postfiles/2015-08-21-por-potential.png)
...
![A state-space amenable to sleep sets, each node represents a state](/postfiles/2015-08-21-sleepsets-potential.png)
...
![The same state space pruning transitions with sleep sets](/postfiles/2015-08-21-sleepsets.png)
